...
- **Devin chat** — describe what you want (e.g. "a KYC review queue with customer info and an audit log") and matching blocks are created and auto-linked on the board — or ask a conceptual question instead ("how do links work?", "where is my form data stored?", "what does the Review Queue do?") and it explains that part of the builder rather than dropping blocks
