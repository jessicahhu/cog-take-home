...
- **Backend selector** — choose where runtime data lives: in-memory, browser storage (persists between runs), or an HTTPS endpoint you own — plain REST, AWS (API Gateway + Lambda), or Azure (Functions)
